/* ============================================================
 * /tools — Bioinformatics tools interface (XTree + MAGUS)
 * ============================================================
 * Moved from the original root page.tsx.
 * This page is gated behind authentication (access code).
 * Contains the tab-switched XTree and MAGUS interfaces.
 * ============================================================ */
...
export default function ToolsPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen px-6 py-10 pt-24">
